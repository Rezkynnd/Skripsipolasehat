...
const kolestrolRoutes = require('./routes/kolestrol');
const asamuratRoutes = require('./routes/asamurat');
const konsulRoutes = require('./routes/konsultasi');
const guladarahRoutes = require('./routes/guladarah');
const olahragaRoutes = require('./routes/olahraga');
...
app.use('/kolestrol', kolestrolRoutes);
app.use('/konsultasi', konsulRoutes);
app.use('/asamurat', asamuratRoutes);
app.use('/guladarah', guladarahRoutes);
app.use('/olahraga', olahragaRoutes);
